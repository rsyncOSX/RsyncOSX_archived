...
If you are on *macOS Sonoma* use RsyncUI. RsyncUI is under activ development now and in the future. 
...
| ----------- | ----------- |   ----------- | -------- |  -------- | -------- |
| RsyncUI   | about 13.7k | 161  | SwiftUI, declarativ     | v1.8.0 - [18 December 2023](https://github.com/rsyncOSX/RsyncUI/releases)  | 6 May 2021  | 
...
[![GitHub license](https://img.shields.io/github/license/rsyncOSX/RsyncUI)](https://github.com/rsyncOSX/RsyncUI/blob/main/Licence.MD) ![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v1.8.0/total) ![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v1.7.9/total)  [![Netlify Status](https://api.netlify.com/api/v1/badges/1d14d49b-ff14-4142-b135-771db071b58a/deploy-status)](https://app.netlify.com/sites/rsyncui/deploys) [![GitHub issues](https://img.shields.io/github/issues/rsyncOSX/RsyncUI)](https://github.com/rsyncOSX/RsyncUI/issues)

**RsyncUI** is released for **macOS Sonoma**. Latest build is [18 December 2023](https://github.com/rsyncOSX/RsyncUI/releases).
