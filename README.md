...
RsyncOSX is only verified with rsync versions 2.6.9, 3.1.2, 3.1.3 and 3.2.0. Other versions of rsync will work but numbers about transferred files is not set in logs. It is recommended to [install](https://rsyncosx.netlify.app/post/rsyncosx/) the latest version of rsync.
