...
This repository is updated for Xcode 10.2 and Swift 5. Both are still in beta and yet not released by Apple. The branch "fixes-current-version" is for updating fixes to the released version of RsyncOSX if the upcoming release of Xcode 10.2 and Swift 5 takes some time.
