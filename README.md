...
**RsyncOSX version 6.6.4** is released for **macOS Big Sur** and later. Due to requirements of some features in Combine, this version is built for macOS Big Sur and later.
