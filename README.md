...
| ----------- | ----------- |   ----------- | -------- |  -------- | -------- |
| RsyncUI   | about 15.5k | 175  | SwiftUI, declarativ     | v1.8.0rc - [16 December 2023](https://github.com/rsyncOSX/RsyncUI/releases)  | 6 May 2021  | 
