...
//swiftlint:disable syntactic_sugar file_length disable cyclomatic_complexity line_length
...
class ViewControllerRsyncParameters: NSViewController {
    ...
    @IBAction func suffix(_ sender: NSButton) {
        ...
        case .on:
            self.setValueComboBox(combobox: self.parameter14, index: (self.parameters!.valueCombo(self.parameters!.getSuffixString()[0])))
            self.viewParameter14.stringValue = self.parameters!.displayValue(self.parameters!.getSuffixString()[0])
        case .off:
            self.setValueComboBox(combobox: self.parameter14, index: (0))
            self.viewParameter14.stringValue = ""
        default:
    ...
    @IBAction func suffix2(_ sender: NSButton) {
        ...
        case .on:
            self.setValueComboBox(combobox: self.parameter14, index: (self.parameters!.valueCombo(self.parameters!.getSuffixString2()[0])))
            self.viewParameter14.stringValue = self.parameters!.displayValue(self.parameters!.getSuffixString2()[0])
        case .off:
            self.setValueComboBox(combobox: self.parameter14, index: (0))
            self.viewParameter14.stringValue = ""
        default:
