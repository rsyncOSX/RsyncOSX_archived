...
final class AllConfigurations: Sorting {
    ...
    private func setConfigurationsDataSourcecountBackupSnapshot() {
        ...
        var configurations: [Configuration] = self.allconfigurations!.filter({return ($0.task == ViewControllerReference.shared.backup || $0.task == ViewControllerReference.shared.snapshot )})
